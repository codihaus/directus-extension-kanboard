<template>
    <div class="field">
        ...
        <v-select v-model="groupByFieldWritable" :items="enumLikeFields" item-text="name" item-value="field" />
    </div>
    <div class="field">
        <div class="type-label">{{ "Header" }}</div>
        <v-field-template v-model="headerTemplateWritable" :collection="collection" />
    </div>
    <div class="field">
        <div class="type-label">{{ "Content" }}</div>
        <v-field-template v-model="cardContentTemplateWritable" :collection="collection" />
    </div>
    <div class="field">
